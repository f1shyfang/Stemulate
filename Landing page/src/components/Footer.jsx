    ...
    <div className='w-full bg-white py-24'>
        <div className='md:max-w-[1480px] m-auto grid md:grid-cols-5 max-[780px]:grid-cols-2  gap-8 max-w-[600px]  px-4 md:px-0'>
            ...
            <div className='col-span-2'>
                ...
                <h3 className='py-2 text-[#6D737A]'>Call : (248)434-5508</h3>
                <h3 className='py-2 text-[#6D737A]'>Github : https://github.com/f1shyfang/Stemulate <br></br> Bleh.</h3>
                <h3 className='py-2 text-[#363A3D]'>Email: StemulateHsc@gmail.com</h3>
            ...
            <div className='max-[780px]:col-span-2'>
                ...
                <h3 className='py-2 text-[#6D737A]'>Weekly newsletter <br></br> tips </h3>
                <form className='py-4'>
                    <input 
